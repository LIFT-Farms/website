                        ...
                        <div className="w-full flex justify-center">
                            <div className="w-full md:w-[80%] text-white text-center flex flex-col items-center">
                                ...
                                <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                                    <Link href='mailto:info@liftgroup.online' target="_blank" className="rounded-md block w-full sm:w-auto font-inter font-medium text-[1rem] sm:text-[1.1rem] md:text-[1.27rem] py-6 md:py-7 px-6 bg-white text-primary-dark hover:bg-gray-100 flex items-center justify-center gap-x-2 transition-transform hover:scale-105 active:scale-95">
                                        <Mail className="w-5 h-5"/>
                                        <span>Email Our Team</span>
                                    </Link>
                                    <Link href='https://wa.me/+23278362263?text=Hello, I would like to partner with LiFT Group' target='_blank' className="rounded-md block w-full sm:w-auto font-inter font-medium text-[1rem] sm:text-[1.1rem] md:text-[1.27rem] py-6 md:py-7 px-6 bg-tertiary text-tertiary-medium hover:bg-tertiary/90 flex items-center justify-center gap-x-2 transition-transform hover:scale-105 active:scale-95">
